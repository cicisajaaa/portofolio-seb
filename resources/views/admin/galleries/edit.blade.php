...
Perbarui dokumentasi kegiatan perusahaan
...
{{ old('project_id',$gallery->project_id) == $project->id ? 'selected' : '' }}>
...
class="mt-3 w-64 h-48 object-cover rounded-xl border">


@else


<div class="mt-3 w-64 h-48 bg-gray-100 rounded-xl flex items-center justify-center text-gray-400">
